  ...
  return (
    <div className="relative w-full">
      <input
        ...
        className={`border-gray-300 focus:ring-indigo-400 w-full rounded-lg border bg-white px-3 py-2 text-gray-900 focus:outline-none focus:ring-2 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 ${
