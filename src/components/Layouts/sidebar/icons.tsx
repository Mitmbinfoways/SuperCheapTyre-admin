...
export function TaxIcon(props: PropsType) {
  return (
    <svg
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6 2.25A2.25 2.25 0 003.75 4.5v15A2.25 2.25 0 006 21h12a2.25 2.25 0 002.25-2.25v-15A2.25 2.25 0 0018 2.25H6zm11.25 4.5H6.75v-3h10.5v3z"
      />

      {/* Buttons */}
      <path d="M7.5 10.5h3v3h-3v-3zM13.5 10.5h3v3h-3v-3zM7.5 15h3v3h-3v-3z" />

      {/* Percentage */}
      <path d="M13 16a1 1 0 100-2 1 1 0 000 2zM16 13a1 1 0 100-2 1 1 0 000 2z" />
      <path d="M12.47 16.53a.75.75 0 001.06 0l3-3a.75.75 0 00-1.06-1.06l-3 3a.75.75 0 000 1.06z" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6.75 2.25a.75.75 0 00-1.5 0V3A2.25 2.25 0 003 5.25v13.5A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V5.25A2.25 2.25 0 0018.75 3h-.75V2.25a.75.75 0 00-1.5 0V3h-9V2.25a.75.75 0 00-1.5 0V3h-.75zM4.5 8.25h15v10.5a.75.75 0 01-.75.75H5.25a.75.75 0 01-.75-.75V8.25z"
      />
      <path d="M12 10.5a.75.75 0 01.75.75v2.25H15a.75.75 0 010 1.5h-2.25V17a.75.75 0 01-1.5 0v-2.25H9a.75.75 0 010-1.5h2.25V11.25a.75.75 0 01.75-.75z" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M11.105 1.553a2.25 2.25 0 011.79 0l7.5 3.214A2.25 2.25 0 0122 6.857v10.286a2.25 2.25 0 01-1.605 2.09l-7.5 2.571a2.25 2.25 0 01-1.79 0l-7.5-2.571A2.25 2.25 0 012 17.143V6.857a2.25 2.25 0 011.605-2.09l7.5-3.214zM12 3.23L4.5 6.429v10.285l7.5 2.572 7.5-2.572V6.429L12 3.23zm-.75 6.52a.75.75 0 01.75-.75h6a.75.75 0 010 1.5h-6a.75.75 0 01-.75-.75z"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 2.25a9.75 9.75 0 110 19.5 9.75 9.75 0 010-19.5zM11.25 8a.75.75 0 011.5 0v3.25H16a.75.75 0 010 1.5h-3.25V16a.75.75 0 01-1.5 0v-3.25H8a.75.75 0 010-1.5h3.25V8z"
      />
    </svg>
  );
}

export function CalendarDaysIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6.75 2a.75.75 0 01.75.75V4h9V2.75a.75.75 0 011.5 0V4h.75A2.25 2.25 0 0121 6.25v13A2.75 2.75 0 0118.25 22H5.75A2.75 2.75 0 013 19.25v-13A2.25 2.25 0 015.25 4H6V2.75a.75.75 0 01.75-.75zM4.5 8.25v11c0 .69.56 1.25 1.25 1.25h12.5c.69 0 1.25-.56 1.25-1.25v-11H4.5zm3.75 2a.75.75 0 01.75.75v.75h.75a.75.75 0 010 1.5H9v.75a.75.75 0 01-1.5 0V13H6.75a.75.75 0 010-1.5H7.5v-.75a.75.75 0 01.75-.75zM12 11.75a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5H12zm0 3a.75.75 0 000 1.5h2.25a.75.75 0 000-1.5H12z"
      />
    </svg>
  );
}
...
export function ShoppingCartIcon(props: PropsType) {
  return (
    ...
    >
      <path
        d="M3.75 3a.75.75 0 000 1.5h1.746l.867 4.336a.75.75 0 00.734.589h11.478a.75.75 0 01.728.94l-1.2 4.5a.75.75 0 01-.728.56H9a.75.75 0 000 1.5h7.875a2.25 2.25 0 002.178-1.68l1.2-4.5a2.25 2.25 0 00-2.178-2.82H7.92l-.66-3.3A1.5 1.5 0 005.496 3H3.75zM8.25 20.25a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm9 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15 6.75a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zm-3.75 5.25a6.75 6.75 0 00-6.75 6.75.75.75 0 01-1.5 0 8.25 8.25 0 0116.5 0 .75.75 0 01-1.5 0 6.75 6.75 0 00-6.75-6.75zM19.5 10.5a.75.75 0 01.75.75V13h1.75a.75.75 0 010 1.5H20.25v1.75a.75.75 0 01-1.5 0V14.5h-1.75a.75.75 0 010-1.5h1.75v-1.75a.75.75 0 01.75-.75z"
      />
    </svg>
  );
}
